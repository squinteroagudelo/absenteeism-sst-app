    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="clearfix pb-2">
                <button class="btn btn-sm btn-success float-right" data-toggle="modal" data-target="#userModal"
                        aria-label="Crear"><i class="fa-plus-circle fas "></i><span class="mx-1">Nuevo</span></button>
            </div>
...
@section('js')
                ...
                'buttons': [
                    {
                        ...
                        'buttons': [
                            ...
                            },
                            {
                                ...
                                'download': 'open',
                                // puede usarse para agregar el logo de la empresa en el pdf
                            ...
                            {
                                'extend': 'colvis',
                                'text': '<i class="fas fa-lg fa-eye"></i>',
    ...
    <script defer src="{{ asset('resources/js/users.js') }}"></script>
@stop
